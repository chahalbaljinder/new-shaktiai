"""
Simplified Database Configuration for SHAKTI-AI Wishes Vault
This version works without Streamlit session state dependencies.
"""
...
DB_CONFIG = {
    ...
    'password': os.getenv('DB_PASSWORD', '8810'),
...
class WishesDatabase:
    ...
    def get_wishes(self, user_id, limit=10):
        ...
        try:
            ...
            for wish in wishes:
                ...
                # Handle sharing_preferences - PostgreSQL JSONB returns as dict already
                if wish['sharing_preferences']:
                    if isinstance(wish['sharing_preferences'], str):
                        ...
                        # Already a dict from PostgreSQL JSONB, keep as is
                        pass
                    else:
            ...
            print(f"Failed to get wishes: {e}")
            return []
    ...
    def update_wish(self, wish_id, user_id, content=None, contact_name=None, 
        ...
        try:
            ...
            print(f"Failed to update wish: {e}")
            return False
    ...
    def delete_wish(self, wish_id, user_id):
        ...
        try:
            ...
            print(f"Failed to delete wish: {e}")
            return False
    ...
    def log_sharing(self, wish_id, shared_with, sharing_method, status='sent', notes=None):
        ...
        try:
            ...
            print(f"Failed to log sharing: {e}")
            return False
    ...
    def get_sharing_history(self, user_id, limit=20):
        ...
        try:
            ...
            print(f"Failed to get sharing history: {e}")
            return []
